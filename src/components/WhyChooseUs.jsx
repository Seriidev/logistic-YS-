  ...
  return (
    <section className="page-container min-w-0 py-10 sm:py-16">
      ...
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-10 items-stretch min-w-0">
        ...
        <div className="w-full lg:w-95 lg:shrink-0 h-64 sm:h-80 lg:h-115 rounded-2xl sm:rounded-3xl overflow-hidden bg-gray-100 flex items-center justify-center">
          {imageError ? (
